...
namespace WebApplication1
{
    ...
    {
        List<SPDTO> LaySanPhamTheoMa(int MaLoai)
        {
            ...
            string sql = "SELECT * FROM [QLDA].[dbo].[SANPHAM] WHERE MaLoai = " + MaLoai.ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(Request.QueryString["MaLoai"], out MaLoai))
            {
                ...
                pnlLoi.Visible = true;
                lblloi.Text = "Không tìm thấy sản phẩm";
                return;
            }

            Repeater1.DataSource = LaySanPhamTheoMa(MaLoai);
            Repeater1.DataBind();
        }
    }
}